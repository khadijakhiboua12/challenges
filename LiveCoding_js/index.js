...
console.log("le nombre  de destination est :",countTotalDestinations());
...
function calculateTotalRevenue() {
 ...
 console.log("le prix total est ",calculateTotalRevenue());
...
// RESTRICTION use Only for, while, and standard logic. //max booking
function findMostExpensiveBooking() {
         let max=spaceData.bookings[0].totalPrice;
        for(let i=0;i<spaceData.bookings.length;i++){
...
console.log("le max prix d'un bookig est ",findMostExpensiveBooking());
